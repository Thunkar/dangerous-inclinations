...
If your ship was destroyed, your whole turn is: place it on your Home sector (nearest empty sector if occupied), full hull, full fuel, heat 0, no energy on any tile, and drift with the ring like any ship that coasts. Face-up tiles stay face-up. Play passes. **Until your next turn is over nobody can touch you**: no weapon fires at you, no missile attacks you and nobody scans you. That next turn is **a first round of your own**: you power, rotate and move as usual, but no weapon of yours fires and you scan nobody. From the turn after it you are live again, and so is everyone's aim at you.

Otherwise:

1. **Clear your loadout.** Take every energy cube off your tiles and put it back in the supply. Whatever you powered last turn has done its job.
2. **Actions,** in any order you choose. Each tile does one thing a turn (a ballistic rack also intercepts during other players' turns):
...
5. **Heat check.** Every energy cube on your loadout is 1 heat. **If your heat is now 0**, repair one broken tile of your choice. Above **10** (the **redline**), the excess is hull damage and your heat drops to 10. Then dissipate; what is left stays on the track for next turn.
...
**Every action puts energy on the tile it uses, and every energy cube on your loadout is a point of heat at your heat check.** The energy stays on the tile until the start of your next turn, when you clear your loadout. That is the whole of energy.
...
- **Powering is an action too**, for the three tiles that work on other players' turns: **shields** (2 or 4), a **ballistic rack** (2) and a **sensor array** (2). A tile with energy on it works until your next turn: shields absorb, a rack shoots down missiles, a sensor widens your critical range. So a rack you fired is also up, and a sensor you scanned with widens the range of every shot you take after the scan. Keeping a wall up means powering it every turn, and paying for it at every check.
- **Each tile does one thing a turn**: you power it or you use it. A salvo is one use of the missiles tile and a turn of interceptions is one use of the ballistic rack, whatever the count.
...
- **Shields turn the damage they stop into heat.** Two energy absorb one point and become 2 heat, so a tile takes 2 energy or 4 and never an odd one. Shields are electromagnetic: they stop railgun slugs, ballistic rack rounds and missiles, **not lasers**.
- Two tiles at four absorb 4 damage. They are also **8 heat every turn** against a dissipation of 5, so a full wall costs three hull a turn once the track saturates, before the ship does anything else. Nothing forbids it; the arithmetic does.
...
**Powering a tile does not turn it over.** The energy goes on the slot where
everyone can count it, and the tile stays face-down: a wall you never needed,
...
Energy is the tell. Using a tile turns it face-up, so energy on a **face-down** slot between turns means it was powered, not used: two is a half shield, a ballistic rack or a sensor array, and four can only be a full shield. That is a deduction from the energy, not a reveal: the tile is still face-down and a scan still costs you a turn to be sure. Shields go in the bow or on a side precisely so that a loaded bow is a guess and not a certain sensor array.
...
|                  |                                                                                                                                                                       |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Energy           | **every action puts energy on the tile it uses; every cube on your loadout is 1 heat at your check**; clear your loadout at the start of your turn |
...
| Critical         | names any slot; breaks it through shields, and dumps its energy as heat (a tile holds its energy until its owner's next turn)                                        |
...
| Salvo            | one action launches any number of your missiles at one ship, for the tile's 2 energy once; a rack with energy on it rolls at 4 of them a turn, one rack per 4          |
...
3. Actions in your order: power (shields, racks, sensors) · rotate · move (coast / burn / jump) · fire · scan. Each tile does one thing.
4. Your missiles move.
5. Just arrived at a station? Load, deliver, repair, full hull, reload. Moored until you burn away.
6. Heat check: every energy cube on your loadout is 1 heat; at 0 heat repair one tile; over 10 is hull damage; dissipate and carry the rest.
