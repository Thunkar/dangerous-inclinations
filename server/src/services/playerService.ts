...
export async function createPlayer(playerName: string, playerId?: string): Promise<PlayerAuth> {
...
export async function updatePlayerName(playerId: string, playerName: string): Promise<boolean> {
  const redis = getRedis()
